...
import com.l2jserver.configurator.files.BuffShopConfig;
import com.l2jserver.configurator.files.NewbieConfig;
import com.l2jserver.configurator.files.RateEventConfig;
...
public final class Config
{
	...
	// Customs
	// --------------------------------------------------
	public static final String CASTLE_SIEGE_REWARD_SYSTEM = "./config/Custom/CastleSiegeRewardSystem.properties";
	public static final String DRESS_ME = "./config/Custom/DressMe.properties";
	...
	public static final String COMMUNITY_PVP = "./config/Custom/CommunityBoard.properties";
	public static final String FAKEPCS_CONFIG = "./config/Custom/FakePcs.properties";
	public static final String QUAKE_PVP = "./config/Custom/QuakePvP.properties";
	public static final String RATES_BY_DAYS = "./config/Custom/RatesByDay.properties";
	public static final String PARTY_NOBLESS = "./config/Custom/SetPartyNobles.properties";
	// --------------------------------------------------
	// Customs - NPCs
	// --------------------------------------------------
	...
	public static final String MULTICLASS_NPC = "./config/Custom/NPC_MultiClass.properties";
	public static final String STATS_ENCHNATER_NPC = "./config/Custom/NPC_StatsEnchanter.properties";
	public static final String MONSTER_ACHIEVEMENTS_NPC = "./config/Custom/NPC_MonsterAchievements.properties";
	// --------------------------------------------------
	// Events
	// --------------------------------------------------
	...
	public static final String PC_BANGS = "./config/Events/PcBangs.properties";
	...
	// --------------------------------------------------
	public static final String BOSS_ZONES = "./config/GrandBossAndZones/BossZones.properties";
	...
	public static final String CHAMBER_OF_DELUSION = "./config/GrandBossAndZones/ChamberOfDelusion.properties";
	public static final String ISLE_OF_PRAYER = "./config/GrandBossAndZones/IsleOfPrayer.properties";
	public static final String KAMALOKA = "./config/GrandBossAndZones/Kamaloka.properties";
	public static final String NORNILS_GARDEN = "./config/GrandBossAndZones/NornilsGarden.properties";
	...
	public static final String QUESTS = "./config/Playable/Quests.properties";
	...
	// TODO: Rework to Lineage 2 Revolution style.
	...
	public static final int PLAYERS_NAME_COLOR = 0xFFFFFF;
	/** The hexadecimal Color of players name (white is 0xFFFFFF) */
	public static final int PLAYERS_TITLE_COLOR = 0xFFFF77;
	
	// --------------------------------------------------
	// BACK BUFF ID
	// --------------------------------------------------
	public static final int BACK_BUFF_ID = 10006;
	
	// --------------------------------------------------
	// Quests
	// --------------------------------------------------
	public static int QUEST_RESET_HOUR;
	public static int QUEST_RESET_MINUTES;
	public static boolean QUEST_REWARD_SOCIAL_ACTION;
	public static boolean QUEST_REWARD_FIREWORK;
	...
	public static int MAXIMIUM_SAVED_TELEPORTS;
	public static int PRICE_FOR_USE_SAVED_TELEPORT;
	...
	public static int SERVICES_GET_NOBLES_ID;
	public static long SERVICES_GET_NOBLES_ID_COUNT;
	public static int SERVICES_CB_NOBLESS_NEED_MIN_LV;
	public static boolean SERVICES_CB_NOBLESS_NEED_PREMIUM;
	public static int SERVICES_CHANGE_NAME_ID;
	public static long SERVICES_CHANGE_NAME_ID_COUNT;
	public static int SERVICES_CHANGE_NAME_MIN_LV;
	public static boolean SERVICES_CHANGE_NAME_NEED_PREMIUM;
	public static int SERVICES_CLAN_CHANGE_NAME_ID;
	public static long SERVICES_CLAN_CHANGE_NAME_ID_COUNT;
	public static int SERVICES_CLAN_CHANGE_MIN_LV;
	public static int SERVICES_GET_FAMES_ID;
	public static long SERVICES_GET_FAMES_ID_COUNT;
	public static int SERVICES_FAMES_MIN_LV;
	public static boolean SERVICES_FAMES_NEED_PREMIUM;
	public static int SERVICES_GET_RECS_ID;
	public static long SERVICES_GET_RECS_ID_COUNT;
	public static int SERVICES_RECS_MIN_LV;
	public static boolean SERVICES_RECS_NEED_PREMIUM;
	public static int SERVICES_GET_PREMIUM_ID;
	public static long SERVICES_GET_PREMIUM_ID_COUNT;
	
	// --------------------------------------------------
	// Isle of Prayer
	// --------------------------------------------------
	public static int DELAY_SPAWN_MONSTERS_DARK_WATER_DRAGON;
	public static int ISLE_OF_PRAYER_MIN_LV_TO_RACE;
	public static int DARK_CLOUD_MANSION_MAX_MEMBERS_IN_PT;
	public static int DARK_CLOUD_MANSION_MIN_LV;
	public static int CRYSTAL_CAVERNS_MIN_LV;
	
	// --------------------------------------------------
	// Isle of Souls
	// --------------------------------------------------
	public static int NORNILS_GARDEN_MIN_LV;
	public static int NORNILS_GARDEN_MAX_LV;
	// --------------------------------------------------
	// Kamaloka
	// --------------------------------------------------
	public static int KAMALOKA_RESET_HOUR;
	public static int KAMALOKA_RESET_MIN;
	public static int KAMALOKA_EMPTY_DESTROY_TIME;
	public static int KAMALOKA_EXIT_TIME;
	public static int KAMALOKA_MAX_LEVEL_DIFFERENCE;
	public static boolean KAMALOKA_STEALTH_SHAMAN;
	// --------------------------------------------------
	// Chamber of Delusion
	// --------------------------------------------------
	public static int CHAMBER_OF_DELUSION_MIN_LV;
	public static long CHAMBER_OF_DELUSION_ROOM_CHANGE_INTERVAL;
	public static int CHAMBER_OF_DELUSION_ROOM_CHANGE_RANDOM_TIME;
	
	// --------------------------------------------------
	// Seed of infinity Instances
	// --------------------------------------------------
	public static int EROSION_ATTACK_MIN_LEVEL_75;
	public static int EROSION_ATTACK_MAX_LEVEL_85;
	public static int EROSION_DEFENCE_MIN_LEVEL_75;
	public static int EROSION_DEFENCE_MAX_LEVEL_85;
	public static int HALL_OF_SUFFERING_ATTACK_MIN_LV_75;
	public static int HALL_OF_SUFFERING_DEFENCE_MIN_LV_75;
	public static int HALL_OF_SUFFERING_DEFENCE_MAX_LV_82;
	public static int HEART_INFINITY_ATTACK_MIN_LV;
	public static int HEART_INFINITY_ATTACK_MAX_LV;
	public static int HEART_INFINITY_DEFENCE_MIN_LV;
	public static int HEART_INFINITY_DEFENCE_MAX_LV;
	
	// --------------------------------------------------
	// Seed of Destruction
	// --------------------------------------------------
	public static int SEED_OF_DESTRUCTION_MIN_LEVEL;
	public static int SEED_OF_DESTRUCTION_MIN_PLAYERS;
	public static int SEED_OF_DESTRUCTION_MAX_PLAYERS;
	public static int SEED_OF_DESTRUCTION_MAX_MOBS_SPAWNED;
	// Initialization at 6:30 am on Wednesday and Saturday
	public static final int SEED_OF_DESTRUCTION_RESET_HOUR = 6;
	public static final int SEED_OF_DESTRUCTION_RESET_MIN = 30;
	public static final int SEED_OF_DESTRUCTION_RESET_DAY_1 = 4;
	public static final int SEED_OF_DESTRUCTION_RESET_DAY_2 = 7;
	
	// thuesday, friday
	public static final int LINDVIOR_RESET_HOUR_18 = 18;
	public static final int LINDVIOR_RESET_HOUR_MIN_58 = 58;
	
	// --------------------------------------------------
	// Freya
	// --------------------------------------------------
	public static final int FREYA_STEWARD_MIN_LV_TELEPORT = 82;
	public static final int ICE_QUEEN_CASTLE_QUEST_MIN_LV = 82;
	public static final int JINIA_MIN_LV_TO_FINISH_10286 = 82;
	
	// --------------------------------------------------
	// Custom Protection for boss zones
	// --------------------------------------------------
	public static int AQ_ZONE_MAX_LV;
	public static boolean AQ_ZONE_GIVE_NOBLESS;
	public static int ORF_ZONE_MAX_LV;
	public static boolean ORF_ZONE_GIVE_NOBLESS;
	public static int CORE_ZONE_MAX_LV;
	public static boolean CORE_ZONE_GIVE_NOBLESS;
	public static int BAIUM_ZONE_MAX_LV;
	public static boolean BAIUM_ZONE_GIVE_NOBLESS;
	public static int ANT_ZONE_MAX_LV;
	public static boolean ANT_ZONE_GIVE_NOBLESS;
	public static int VAL_ZONE_MAX_LV;
	public static boolean VAL_ZONE_GIVE_NOBLESS;
	
	// --------------------------------------------------
	// Buff Shop MOD
	// --------------------------------------------------
	public static boolean ENABLE_BUFF_SHOP_MODE;
	public static boolean ENABLE_BUFF_SHOP_ZONE;
	public static int[] BUFFSHOP_ALLOWED_BUFFS;
	public static int MAXIMUM_BUFF;
	public static int MIN_PRICE;
	public static int MIN_LETTERS_FOR_TITLE;
	public static int MAX_LETTERS_FOR_TITLE;
	public static int MIN_DISTANCE_NEAR_THE_SHOP;
	public static int MAX_RANGE_FOR_CAST;
	// --------------------------------------------------
	// Achievements NPCs
	// --------------------------------------------------
	public static boolean USE_ACHIEVEMENT_NPC;
	public static int ACHIEVEMENT_NPC_ID;
	// --------------------------------------------------
	// Character Creating - Race, sex
	// --------------------------------------------------
	public static boolean DISABLE_CREATING_HUMAN;
	public static boolean DISABLE_CREATING_ELF;
	public static boolean DISABLE_CREATING_DARK_ELF;
	public static boolean DISABLE_CREATING_ORC;
	public static boolean DISABLE_CREATING_DWARF;
	public static boolean DISABLE_CREATING_KAMAEL;
	public static boolean DISABLE_CREATING_MEN;
	public static boolean DISABLE_CREATING_WOMEN;
	// --------------------------------------------------
	// Character Level Stats
	// --------------------------------------------------
	public static byte MAXIMIUM_PLAYER_LEVEL;
	public static byte MAXIMIUM_PET_LEVEL;
	public static byte MINIMUM_NEWBIE_LEVEL;
	public static byte MAXIMIUM_NEWBIE_LEVEL;
	// --------------------------------------------------
	// Castle Siege Reward System
	// --------------------------------------------------
	public static boolean ALLOW_CASTLE_SIEGE_REWARD_SYS;
	public static int CLAN_POINTS_FOR_KILL;
	// --------------------------------------------------
	// Developers settings
	// --------------------------------------------------
	public static boolean DEBUG_TIMERS;
	public static boolean DEBUG_REQUEST_BYPASS_TO_SERVER;
	public static boolean ENABLE_HTML_PATH;
	public static boolean DEBUG_DROP_CHANCE;
	// --------------------------------------------------
	// ETC MODS
	// --------------------------------------------------
	public static boolean ENABLE_PARTY_NOBLES;
	// --------------------------------------------------
	// Dressme
	// --------------------------------------------------
	public static boolean ALLOW_DRESS_ME_SYSTEM;
	public static boolean DRESS_ME_ONLY_FOR_PREMIUM;
	public static int DRESS_ME_MAXIMUM_TEMPLATES;
	public static int DRESS_ME_ARMOR_CONSUME_ID;
	public static int DRESS_ME_ARMOR_CONSUME_COUNT;
	public static int DRESS_ME_WEAPON_CONSUME_ID;
	public static int DRESS_ME_WEAPON_CONSUME_COUNT;
	public static int DRESS_ME_CLOAK_CONSUME_ID;
	public static int DRESS_ME_CLOAK_CONSUME_COUNT;
	public static int DRESS_ME_AGATHION_CONSUME_ID;
	public static int DRESS_ME_AGATHION_CONSUME_COUNT;
	public static int DRESS_ME_TARGET_CONSUME_ID;
	public static int DRESS_ME_TARGET_CONSUME_COUNT;
	public static int DRESS_ME_TRANSFORM_CONSUME_ID;
	public static int DRESS_ME_TRANSFORM_CONSUME_COUNT;
	// --------------------------------------------------
	// Multiclass
	// --------------------------------------------------
	public static boolean USE_MULTICLASS_NPC;
	public static int MULTICLASS_NPC_ID;
	public static int MULTICLASS_MIN_LEVEL_TO_TRANSFER;
	public static String MULTICLASS_START_LV;
	public static int MULTICLASS_REW_ID_1;
	public static long MULTICLASS_REW_COUNT_1;
	public static int MULTICLASS_REW_ID_2;
	public static long MULTICLASS_REW_COUNT_2;
	public static int MULTICLASS_REW_ID_3;
	public static long MULTICLASS_REW_COUNT_3;
	public static boolean DISABLED_KAMAELS_OTHERS_RACES;
	// --------------------------------------------------
	// Stats Enchanter
	// --------------------------------------------------
	public static int NPC_ID_ENCHANTER; // 50023
	public static boolean USE_STATS_ENCHANTER;
	// Themes
	public static int STATS_MAXIMUM_TEMPLATES;
	// Chances
	public static int CHANGE_UP_STR;
	public static int CHANGE_UP_INT;
	public static int CHANGE_UP_DEX;
	public static int CHANGE_UP_WIT;
	public static int CHANGE_UP_CON;
	public static int CHANGE_UP_MEN;
	// Items
	public static boolean PAY_FOR_SERVICE_UP;
	public static int ITEM_CONSUME_UP; // Item Consume id
	public static int ITEM_CONSUME_EACH_LEVEL_UP;
	
	public static boolean PAY_FOR_SERVICE_DOWN;
	public static int ITEM_CONSUME_DOWN; // Item Consume id
	public static long ITEM_CONSUME_EACH_LEVEL_DOWN;
	// --------------------------------------------------
	// Scheme Buffer
	// --------------------------------------------------
	...
	public static long BELETH_WAIT_TIME;
	public static int HELLBOUND_TOWN_MIN_LV;
	// --------------------------------------------------
	// Gracia Seeds
	// --------------------------------------------------
	...
	public static int START_DELAY_FE = 60;
	public static int TIME_BETWEEN_DEMON_SPAWNS = 20000;
	public static int MAX_DEMONS = 24;
	// --------------------------------------------------
	// Land Dragon
	// --------------------------------------------------
	...
	public static int ANTHARAS_ALLOW_MIN_HOUR;
	public static int ANTHARAS_ALLOW_MAX_HOUR;
	public static boolean SPECIFIC_TIME_TO_ENTER_ANTHARAS;
	// --------------------------------------------------
	// Fire Dragon
	// --------------------------------------------------
	...
	public static int VALAKAS_ALLOW_MIN_HOUR;
	public static int VALAKAS_ALLOW_MAX_HOUR;
	public static boolean SPECIFIC_TIME_TO_ENTER_VALAKAS;
	// --------------------------------------------------
	// Baium
	// --------------------------------------------------
	...
	// NPC Settings
	// --------------------------------------------------
	public static int INTERACTION_DISTANCE_NPC;
	...
	public static int ENABLE_RANDOM_ENCHANT_EFFECT_MIN;
	public static int ENABLE_RANDOM_ENCHANT_EFFECT_MAX;
	...
	public static boolean ENABLE_ENCHANT_PVP;
	...
	public static void loadServerConfig()
	{
		...
		// Load Monster Achievements L2Properties file (if exists)
		final File MA = new File(MONSTER_ACHIEVEMENTS_NPC);
		try (InputStream monster_achiev = new FileInputStream(MA))
		{
			L2Properties proper_MA = new L2Properties();
			proper_MA.load(monster_achiev);
			USE_ACHIEVEMENT_NPC = Boolean.parseBoolean(proper_MA.getProperty("Enable", "False"));
			ACHIEVEMENT_NPC_ID = Integer.parseInt(proper_MA.getProperty("NpcId", "50023"));
		}
		catch (Exception e)
		{
			_log.warning("Config: " + e.getMessage());
			throw new Error("Failed to Load " + MONSTER_ACHIEVEMENTS_NPC + " File.");
		}
		
		// Load MULTICLASSC L2Properties file (if exists)
		final File MC = new File(MULTICLASS_NPC);
		try (InputStream multiclass = new FileInputStream(MC))
		{
			L2Properties proper_MC = new L2Properties();
			proper_MC.load(multiclass);
			USE_MULTICLASS_NPC = Boolean.parseBoolean(proper_MC.getProperty("EnableMultiClassNPC", "False"));
			MULTICLASS_NPC_ID = Integer.parseInt(proper_MC.getProperty("MC_NpcId", "50026"));
			MULTICLASS_MIN_LEVEL_TO_TRANSFER = Integer.parseInt(proper_MC.getProperty("MinLv", "75"));
			MULTICLASS_START_LV = proper_MC.getProperty("NewClassStartLv", "40");
			MULTICLASS_REW_ID_1 = Integer.parseInt(proper_MC.getProperty("ItemId1", "57"));
			MULTICLASS_REW_COUNT_1 = Integer.parseInt(proper_MC.getProperty("ItemCount1", "100"));
			MULTICLASS_REW_ID_2 = Integer.parseInt(proper_MC.getProperty("ItemId2", "57"));
			MULTICLASS_REW_COUNT_2 = Integer.parseInt(proper_MC.getProperty("ItemCount2", "100"));
			MULTICLASS_REW_ID_3 = Integer.parseInt(proper_MC.getProperty("ItemId3", "57"));
			MULTICLASS_REW_COUNT_3 = Integer.parseInt(proper_MC.getProperty("ItemCount3", "100"));
			DISABLED_KAMAELS_OTHERS_RACES = Boolean.parseBoolean(proper_MC.getProperty("DisableKOC", "true"));
		}
		catch (Exception e)
		{
			_log.warning("Config: " + e.getMessage());
			throw new Error("Failed to Load " + MULTICLASS_NPC + " File.");
		}
		
		// Load MULTICLASSC L2Properties file (if exists)
		final File SE = new File(STATS_ENCHNATER_NPC);
		try (InputStream stats_enchanter = new FileInputStream(SE))
		{
			L2Properties proper_SE = new L2Properties();
			proper_SE.load(stats_enchanter);
			NPC_ID_ENCHANTER = Integer.parseInt(proper_SE.getProperty("NpcId", "50023"));
			USE_STATS_ENCHANTER = Boolean.parseBoolean(proper_SE.getProperty("UseStatsEnchanter", "False"));
			STATS_MAXIMUM_TEMPLATES = Integer.parseInt(proper_SE.getProperty("MaxSavedTemplates", "5"));
			CHANGE_UP_STR = Integer.parseInt(proper_SE.getProperty("ChanceSTR", "60"));
			CHANGE_UP_INT = Integer.parseInt(proper_SE.getProperty("ChanceINT", "60"));
			CHANGE_UP_DEX = Integer.parseInt(proper_SE.getProperty("ChanceDEX", "45"));
			CHANGE_UP_WIT = Integer.parseInt(proper_SE.getProperty("ChanceWIT", "45"));
			CHANGE_UP_CON = Integer.parseInt(proper_SE.getProperty("ChanceCON", "30"));
			CHANGE_UP_MEN = Integer.parseInt(proper_SE.getProperty("ChanceMEN", "30"));
			PAY_FOR_SERVICE_UP = Boolean.parseBoolean(proper_SE.getProperty("PayForUp", "True"));
			ITEM_CONSUME_UP = Integer.parseInt(proper_SE.getProperty("ItemIdNeedUp", "9143"));
			ITEM_CONSUME_EACH_LEVEL_UP = Integer.parseInt(proper_SE.getProperty("ItemCountNeedUp", "10"));
			PAY_FOR_SERVICE_DOWN = Boolean.parseBoolean(proper_SE.getProperty("PayForDown", "True"));
			ITEM_CONSUME_DOWN = Integer.parseInt(proper_SE.getProperty("ItemIdNeedDown", "4037"));
			ITEM_CONSUME_EACH_LEVEL_DOWN = Integer.parseInt(proper_SE.getProperty("ItemCountNeedDown", "10"));
		}
		catch (Exception e)
		{
			_log.warning("Config: " + e.getMessage());
			throw new Error("Failed to Load " + STATS_ENCHNATER_NPC + " File.");
		}
		...
		try
		{
			L2Properties QuakePvP = new L2Properties(QUAKE_PVP);
		...
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + QUAKE_PVP + " File.");
		}
		
		// Load Quests
		try
		{
			L2Properties Quests = new L2Properties(QUESTS);
			QUEST_RESET_HOUR = Integer.parseInt(Quests.getProperty("QuestResetHour", "6"));
			QUEST_RESET_MINUTES = Integer.parseInt(Quests.getProperty("QuestResetMin", "30"));
			QUEST_REWARD_SOCIAL_ACTION = Boolean.parseBoolean(Quests.getProperty("DoSocialVictory", "false"));
			QUEST_REWARD_FIREWORK = Boolean.parseBoolean(Quests.getProperty("ShowFireworks", "false"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + QUESTS + " File.");
		}
		
		// Load PARTY_NOBLESS
		try
		{
			L2Properties PartyNobless = new L2Properties(PARTY_NOBLESS);
			ENABLE_PARTY_NOBLES = Boolean.parseBoolean(PartyNobless.getProperty("EnablePartyNobless", "false"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + PARTY_NOBLESS + " File.");
		}
		
		// Load PVP Community L2Properties file (if exists)
		try
		{
			L2Properties pvp_com = new L2Properties(COMMUNITY_PVP);
			ENABLE_COMMUNITY_BOARD = Boolean.parseBoolean(pvp_com.getProperty("EnableCb", "true"));
			
			ALLOW_COMMUNITY_MULTISELL = Boolean.parseBoolean(pvp_com.getProperty("EnableGmShop", "false"));
			
			ALLOW_COMMUNITY_TELEPORT = Boolean.parseBoolean(pvp_com.getProperty("EnableTeleport", "false"));
			MAXIMIUM_SAVED_TELEPORTS = Integer.parseInt(pvp_com.getProperty("MaxSavedLocation", "5"));
			PRICE_FOR_USE_SAVED_TELEPORT = Integer.parseInt(pvp_com.getProperty("PriceForUseSavLoc", "100000"));
			
			ALLOW_COMMUNITY_BUFF = Boolean.parseBoolean(pvp_com.getProperty("EnableBuffer", "false"));
			BUFF_COST = Boolean.parseBoolean(pvp_com.getProperty("BuffCost", "true"));
			
			ALLOW_COMMUNITY_ENCHANT = Boolean.parseBoolean(pvp_com.getProperty("EnableEnchant", "false"));
			ENCHANT_ITEM = Integer.parseInt(pvp_com.getProperty("EnchantItem", "4037"));
			
			SERVICES_GET_NOBLES_ID = Integer.parseInt(pvp_com.getProperty("NoblItemId", "57"));
			SERVICES_GET_NOBLES_ID_COUNT = Integer.parseInt(pvp_com.getProperty("NoblItemCount", "5000"));
			SERVICES_CB_NOBLESS_NEED_MIN_LV = Integer.parseInt(pvp_com.getProperty("NoblMinLv", "70"));
			SERVICES_CB_NOBLESS_NEED_PREMIUM = Boolean.parseBoolean(pvp_com.getProperty("NoblNeedPr", "false"));
			
			SERVICES_CHANGE_NAME_ID = Integer.parseInt(pvp_com.getProperty("CHNItemId", "57"));
			SERVICES_CHANGE_NAME_ID_COUNT = Integer.parseInt(pvp_com.getProperty("CHNItemCount", "5000"));
			SERVICES_CHANGE_NAME_MIN_LV = Integer.parseInt(pvp_com.getProperty("CHNMinLv", "70"));
			SERVICES_CHANGE_NAME_NEED_PREMIUM = Boolean.parseBoolean(pvp_com.getProperty("CHNNeedPr", "false"));
			
			SERVICES_CLAN_CHANGE_NAME_ID = Integer.parseInt(pvp_com.getProperty("CCHNItemId", "57"));
			SERVICES_CLAN_CHANGE_NAME_ID_COUNT = Integer.parseInt(pvp_com.getProperty("CCHNItemCount", "5000"));
			SERVICES_CLAN_CHANGE_MIN_LV = Integer.parseInt(pvp_com.getProperty("CCHNMinLv", "3"));
			
			SERVICES_GET_FAMES_ID = Integer.parseInt(pvp_com.getProperty("FItemId", "57"));
			SERVICES_GET_FAMES_ID_COUNT = Integer.parseInt(pvp_com.getProperty("FItemCount", "5000"));
			SERVICES_FAMES_MIN_LV = Integer.parseInt(pvp_com.getProperty("FMinLv", "70"));
			SERVICES_FAMES_NEED_PREMIUM = Boolean.parseBoolean(pvp_com.getProperty("FNeedPr", "false"));
			
			SERVICES_GET_RECS_ID = Integer.parseInt(pvp_com.getProperty("RItemId", "57"));
			SERVICES_GET_RECS_ID_COUNT = Integer.parseInt(pvp_com.getProperty("RItemCount", "5000"));
			SERVICES_RECS_MIN_LV = Integer.parseInt(pvp_com.getProperty("RMinLv", "70"));
			SERVICES_RECS_NEED_PREMIUM = Boolean.parseBoolean(pvp_com.getProperty("RNeedPr", "false"));
			
			SERVICES_GET_PREMIUM_ID = Integer.parseInt(pvp_com.getProperty("PRItemId", "57"));
			SERVICES_GET_PREMIUM_ID_COUNT = Integer.parseInt(pvp_com.getProperty("PRItemCount", "5000"));
		}
		catch (Exception e)
		{
			_log.warning("Config: " + e.getMessage());
		...
		try
		{
			L2Properties Feature = new L2Properties(FEATURE);
		...
		try
		{
			L2Properties Premium = new L2Properties(PREMIUM_SYSTEM_CONFIG);
		...
		try
		{
			L2Properties ENCHNT = new L2Properties(ENCHANT);
			...
			ENABLE_ENCHANT_PVP = Boolean.parseBoolean(ENCHNT.getProperty("EnchantPvP", "false"));
		...
		try
		{
			L2Properties ELEM = new L2Properties(ELEMENT);
		...
		try
		{
			L2Properties Character = new L2Properties(CHARACTER);
			...
			MAXIMIUM_PLAYER_LEVEL = Byte.parseByte(Character.getProperty("MaximumPlayerLevel", "86"));
			MAXIMIUM_PET_LEVEL = Byte.parseByte(Character.getProperty("MaximumPetLevel", "87"));
			MINIMUM_NEWBIE_LEVEL = Byte.parseByte(Character.getProperty("MinimiumNewbieLevel", "6"));
			MAXIMIUM_NEWBIE_LEVEL = Byte.parseByte(Character.getProperty("MaximiumNewbieLevel", "39"));
			...
			if (ENABLE_MODIFY_SKILL_DURATION)
			{
				...
				SKILL_DURATION_LIST = new HashMap<Integer, Integer>(propertySplit.length);
			...
			if (ENABLE_MODIFY_SKILL_REUSE)
			{
				...
				SKILL_REUSE_LIST = new HashMap<Integer, Integer>(propertySplit.length);
				for (String skill : propertySplit)
				{
					String[] skillSplit = skill.split(",");
					if (skillSplit.length != 2)
		...
		try
		{
			...
			L2Properties mmoSettings = new L2Properties(MMO_CONFIG_FILE);
		...
		try
		{
			L2Properties Administrator = new L2Properties(ADMINISTRATORS);
		...
		try
		{
			L2Properties DimensionalRift = new L2Properties(DIMENSIONAL_RIFT);
		...
		try
		{
			L2Properties fs = new L2Properties(FOUR_SEPULCHERS);
		...
		try
		{
			L2Properties Geodata = new L2Properties(GEODATA_PATHNODES);
		...
		try
		{
			L2Properties ItemAuction = new L2Properties(ITEM_AUCTION);
		...
		try
		{
			L2Properties Lottery = new L2Properties(LOTTERY);
		...
		try
		{
			L2Properties Manor = new L2Properties(MANOR);
		...
		try
		{
			L2Properties Punishment = new L2Properties(PUNISHMENT);
		...
		try
		{
			L2Properties ClientPackets = new L2Properties(CLIENT_PACKETS);
		...
		try
		{
			L2Properties CustomSQL = new L2Properties(CUSTOMSQL);
		...
		try
		{
			L2Properties Developers = new L2Properties(DEVELOPER_VARIABLES);
			DEBUG_REQUEST_BYPASS_TO_SERVER = Boolean.parseBoolean(Developers.getProperty("DebugByPasses", "false"));
			ENABLE_HTML_PATH = Boolean.parseBoolean(Developers.getProperty("DebugHtmlPath", "false"));
			DEBUG_DROP_CHANCE = Boolean.parseBoolean(Developers.getProperty("DebugDropChances", "false"));
		...
		try
		{
			L2Properties Optimizaion = new L2Properties(OPTIMIZATION);
		...
		try
		{
			L2Properties Others = new L2Properties(OTHERS);
		...
		try
		{
			L2Properties Security = new L2Properties(SERVER_SECURITY);
		...
		try
		{
			L2Properties ThreadConfiguration = new L2Properties(THREAD_CONFIGURATION);
		...
		try
		{
			L2Properties autores = new L2Properties(AUTO_RESTART);
		...
		try
		{
			L2Properties CtfSettings = new L2Properties(CAPTURE_THE_FLAG);
			...
			{
				CTF_EVENT_FIGHTER_BUFFS = new HashMap<Integer, Integer>(propertySplit.length);
				for (String skill : propertySplit)
				{
					String[] skillSplit = skill.split(",");
					if (skillSplit.length != 2)
			...
			if (!propertySplit[0].isEmpty())
			{
				CTF_EVENT_MAGE_BUFFS = new HashMap<Integer, Integer>(propertySplit.length);
				for (String skill : propertySplit)
				{
					String[] skillSplit = skill.split(",");
					if (skillSplit.length != 2)
		...
		try
		{
			L2Properties HideandSeek = new L2Properties(HIDE_AND_SEEK);
		...
		try
		{
			L2Properties TownWarFiles = new L2Properties(TOWN_WAR);
		...
		try
		{
			L2Properties MREventFiles = new L2Properties(MONSTER_RUSH);
		...
		try
		{
			L2Properties DmSettings = new L2Properties(DEATHMATCH);
		...
		try
		{
			L2Properties Pcbangs = new L2Properties(PC_BANGS);
		...
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + PC_BANGS + " File.");
		}
		
		// Load Handys L2Properties file (if exists)
		try
		{
			L2Properties Handys = new L2Properties(HANDY_BLOCK_CHECKER);
		...
		try
		{
			L2Properties security = new L2Properties(FLOOD_PROTECTOR_FILE);
		...
		try
		{
			L2Properties NPC_SETTINGS = new L2Properties(NPC);
			...
			INTERACTION_DISTANCE_NPC = Integer.parseInt(NPC_SETTINGS.getProperty("InteractionNpcDistance", "150"));
			SHOW_NPC_LVL = Boolean.parseBoolean(NPC_SETTINGS.getProperty("ShowNpcLevel", "False"));
			SHOW_RED_NAME_IF_AGGRO = Boolean.parseBoolean(NPC_SETTINGS.getProperty("ShowRedName", "False"));
			...
			ENABLE_RANDOM_ENCHANT_EFFECT_MIN = Integer.parseInt(NPC_SETTINGS.getProperty("RandomEffectMin", "4"));
			ENABLE_RANDOM_ENCHANT_EFFECT_MAX = Integer.parseInt(NPC_SETTINGS.getProperty("RandomEffectMax", "16"));
		...
		try
		{
			L2Properties ratesSettings = new L2Properties(RATES);
			...
			RATE_VITALITY_LEVEL_1 = Float.parseFloat(ratesSettings.getProperty("RateVitalityLevel1", "0.5"));
			RATE_VITALITY_LEVEL_2 = Float.parseFloat(ratesSettings.getProperty("RateVitalityLevel2", "1.0"));
			RATE_VITALITY_LEVEL_3 = Float.parseFloat(ratesSettings.getProperty("RateVitalityLevel3", "1.5"));
			RATE_VITALITY_LEVEL_4 = Float.parseFloat(ratesSettings.getProperty("RateVitalityLevel4", "2.0"));
		...
		try
		{
			L2Properties ChampionsMonsters = new L2Properties(CHAMPION);
		...
		try
		{
			L2Properties TeamVsTeam = new L2Properties(TVT);
				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							if (!propertySplit[0].isEmpty())
							{
								TVT_EVENT_FIGHTER_BUFFS = new HashMap<Integer, Integer>(propertySplit.length);
								for (String skill : propertySplit)
								{
									String[] skillSplit = skill.split(",");
									if (skillSplit.length != 2)
							...
							if (!propertySplit[0].isEmpty())
							{
								TVT_EVENT_MAGE_BUFFS = new HashMap<Integer, Integer>(propertySplit.length);
								for (String skill : propertySplit)
								{
									String[] skillSplit = skill.split(",");
									if (skillSplit.length != 2)
		...
		try
		{
			L2Properties TeamVsTeamRound = new L2Properties(TVT_ROUND);
				...
				else
				{
					...
					else
					{
						...
						else
						{
							...
							if (!propertySplit[0].isEmpty())
							{
								TVT_ROUND_EVENT_FIGHTER_BUFFS = new HashMap<Integer, Integer>(propertySplit.length);
								for (String skill : propertySplit)
								{
									String[] skillSplit = skill.split(",");
									if (skillSplit.length != 2)
							...
							if (!propertySplit[0].isEmpty())
							{
								TVT_ROUND_EVENT_MAGE_BUFFS = new HashMap<Integer, Integer>(propertySplit.length);
								for (String skill : propertySplit)
								{
									String[] skillSplit = skill.split(",");
									if (skillSplit.length != 2)
		...
		try
		{
			L2Properties Wedding = new L2Properties(WEDDING_SYSTEM);
		...
		try
		{
			L2Properties csrs = new L2Properties(CASTLE_SIEGE_REWARD_SYSTEM);
			ALLOW_CASTLE_SIEGE_REWARD_SYS = Boolean.parseBoolean(csrs.getProperty("AllowCastleSRS", "False"));
			CLAN_POINTS_FOR_KILL = Integer.parseInt(csrs.getProperty("GiveClanPoints", "1"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + CASTLE_SIEGE_REWARD_SYSTEM + " File.");
		}
		// Dressme
		try
		{
			L2Properties dressme = new L2Properties(DRESS_ME);
			ALLOW_DRESS_ME_SYSTEM = Boolean.parseBoolean(dressme.getProperty("AllowDressMeSystem", "False"));
			DRESS_ME_ONLY_FOR_PREMIUM = Boolean.parseBoolean(dressme.getProperty("OnlyForPADM", "False"));
			DRESS_ME_MAXIMUM_TEMPLATES = Integer.parseInt(dressme.getProperty("MaxTemSaved", "3"));
			DRESS_ME_ARMOR_CONSUME_ID = Integer.parseInt(dressme.getProperty("IdConsumeArmor", "57"));
			DRESS_ME_ARMOR_CONSUME_COUNT = Integer.parseInt(dressme.getProperty("CountConsumeArmor", "1"));
			DRESS_ME_WEAPON_CONSUME_ID = Integer.parseInt(dressme.getProperty("IdConsumeWeapon", "57"));
			DRESS_ME_WEAPON_CONSUME_COUNT = Integer.parseInt(dressme.getProperty("CountConsumeWeapon", "1"));
			DRESS_ME_CLOAK_CONSUME_ID = Integer.parseInt(dressme.getProperty("IdConsumeCloak", "57"));
			DRESS_ME_CLOAK_CONSUME_COUNT = Integer.parseInt(dressme.getProperty("CountConsumeCloak", "1"));
			DRESS_ME_AGATHION_CONSUME_ID = Integer.parseInt(dressme.getProperty("IdConsumeAgathion", "57"));
			DRESS_ME_AGATHION_CONSUME_COUNT = Integer.parseInt(dressme.getProperty("CountConsumeAgathion", "1"));
			DRESS_ME_TARGET_CONSUME_ID = Integer.parseInt(dressme.getProperty("IdConsumeTarget", "57"));
			DRESS_ME_TARGET_CONSUME_COUNT = Integer.parseInt(dressme.getProperty("CountConsumeTarget", "1"));
			DRESS_ME_TRANSFORM_CONSUME_ID = Integer.parseInt(dressme.getProperty("IdConsumeTransform", "57"));
			DRESS_ME_TRANSFORM_CONSUME_COUNT = Integer.parseInt(dressme.getProperty("CountConsumeTransform", "1"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + DRESS_ME + " File.");
		}
		
		// Offline Works
		try
		{
			L2Properties OfflineWorks = new L2Properties(OFFLINE_WORKS);
		...
		try
		{
			L2Properties Others = new L2Properties(OTHERS_MODS);
			...
			L2JMOD_DUALBOX_CHECK_WHITELIST = new HashMap<Integer, Integer>(propertySplit.length);
			...
			ANNOUNCE_BOSS_MSG = Others.getProperty("AnnounceBossMsg", Config.SERVER_NAME + ": Raidboss %raidboss% has been spawned!");
		...
		try
		{
			L2Properties pvpSettings = new L2Properties(PVP);
		...
		try
		{
			L2Properties olympiad = new L2Properties(OLYMPIAD);
		...
		try
		{
			L2Properties BZ = new L2Properties(BOSS_ZONES);
			AQ_ZONE_MAX_LV = Integer.parseInt(BZ.getProperty("AQMaxLv", "45"));
			AQ_ZONE_GIVE_NOBLESS = Boolean.parseBoolean(BZ.getProperty("AQEnableNobless", "false"));
			ORF_ZONE_MAX_LV = Integer.parseInt(BZ.getProperty("OrfMaxLv", "45"));
			ORF_ZONE_GIVE_NOBLESS = Boolean.parseBoolean(BZ.getProperty("OrfEnableNobless", "false"));
			CORE_ZONE_MAX_LV = Integer.parseInt(BZ.getProperty("CoreMaxLv", "45"));
			CORE_ZONE_GIVE_NOBLESS = Boolean.parseBoolean(BZ.getProperty("CoreEnableNobless", "false"));
			BAIUM_ZONE_MAX_LV = Integer.parseInt(BZ.getProperty("BaiumMaxLv", "45"));
			BAIUM_ZONE_GIVE_NOBLESS = Boolean.parseBoolean(BZ.getProperty("BaiumEnableNobless", "false"));
			ANT_ZONE_MAX_LV = Integer.parseInt(BZ.getProperty("AntMaxLv", "45"));
			ANT_ZONE_GIVE_NOBLESS = Boolean.parseBoolean(BZ.getProperty("AntEnableNobless", "false"));
			VAL_ZONE_MAX_LV = Integer.parseInt(BZ.getProperty("ValMaxLv", "45"));
			VAL_ZONE_GIVE_NOBLESS = Boolean.parseBoolean(BZ.getProperty("ValEnableNobless", "false"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + BOSS_ZONES + " File.");
		}
		
		// BAIUM
		try
		{
			L2Properties BAIUM_CFG = new L2Properties(BAIUM);
		...
		try
		{
			L2Properties ZAKEN_CFG = new L2Properties(ZAKEN);
		...
		try
		{
			L2Properties CORE_CFG = new L2Properties(CORE);
		...
		try
		{
			L2Properties FRINTEZZA_CFG = new L2Properties(FRINTEZZA);
		...
		try
		{
			L2Properties VALAKAS_CFG = new L2Properties(VALAKAS);
			SPECIFIC_TIME_TO_ENTER_VALAKAS = Boolean.parseBoolean(VALAKAS_CFG.getProperty("SpecidicTimeValakas", "false"));
			VALAKAS_ALLOW_MIN_HOUR = Integer.parseInt(VALAKAS_CFG.getProperty("MinTimeHoursEnter", "20"));
			VALAKAS_ALLOW_MAX_HOUR = Integer.parseInt(VALAKAS_CFG.getProperty("MaxTimeHoursEnter", "23"));
		...
		try
		{
			L2Properties FREYA_CFG = new L2Properties(FREYA);
		...
		try
		{
			L2Properties GRACIA_CFG = new L2Properties(GRACIA);
			// quest
			...
			EROSION_ATTACK_MIN_LEVEL_75 = Integer.parseInt(GRACIA_CFG.getProperty("ErosionAttackMinLv", "75"));
			EROSION_ATTACK_MAX_LEVEL_85 = Integer.parseInt(GRACIA_CFG.getProperty("ErosionAttackMaxLv", "85"));
			EROSION_DEFENCE_MIN_LEVEL_75 = Integer.parseInt(GRACIA_CFG.getProperty("ErosionDefenceMinLv", "75"));
			EROSION_DEFENCE_MAX_LEVEL_85 = Integer.parseInt(GRACIA_CFG.getProperty("ErosionDefenceMaxLv", "85"));
			HALL_OF_SUFFERING_ATTACK_MIN_LV_75 = Integer.parseInt(GRACIA_CFG.getProperty("SufferingAttackMinLv", "75"));
			HALL_OF_SUFFERING_DEFENCE_MIN_LV_75 = Integer.parseInt(GRACIA_CFG.getProperty("SufferingDefenceMinLv", "75"));
			HALL_OF_SUFFERING_DEFENCE_MAX_LV_82 = Integer.parseInt(GRACIA_CFG.getProperty("SufferingDefenceMaxLv", "82"));
			HEART_INFINITY_ATTACK_MIN_LV = Integer.parseInt(GRACIA_CFG.getProperty("HeartAttackMinLv", "75"));
			HEART_INFINITY_ATTACK_MAX_LV = Integer.parseInt(GRACIA_CFG.getProperty("HeartAttackMaxLv", "85"));
			HEART_INFINITY_DEFENCE_MIN_LV = Integer.parseInt(GRACIA_CFG.getProperty("HeartDefenceMinLv", "75"));
			HEART_INFINITY_DEFENCE_MAX_LV = Integer.parseInt(GRACIA_CFG.getProperty("HeartDefenceMaxLv", "85"));
			// SoD
			...
			SEED_OF_DESTRUCTION_MIN_LEVEL = Integer.parseInt(GRACIA_CFG.getProperty("SoDMinLv", "75"));
			SEED_OF_DESTRUCTION_MIN_PLAYERS = Integer.parseInt(GRACIA_CFG.getProperty("SoDMinPlayers", "36"));
			SEED_OF_DESTRUCTION_MAX_PLAYERS = Integer.parseInt(GRACIA_CFG.getProperty("SoDMaxPlayers", "45"));
			SEED_OF_DESTRUCTION_MAX_MOBS_SPAWNED = Integer.parseInt(GRACIA_CFG.getProperty("SoDMaxMobs", "100"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
		...
		try
		{
			L2Properties HELLLBOUND = new L2Properties(HELLBOUND);
			// Hellbound
			...
			// Hellbound Town
			HELLBOUND_TOWN_MIN_LV = Integer.parseInt(HELLLBOUND.getProperty("TownMinLv", "78"));
			// Beleth
			...
			BELETH_WAIT_TIME = Long.parseLong(HELLLBOUND.getProperty("BelethWaitTime", "300000"));
		...
		try
		{
			L2Properties IOP = new L2Properties(ISLE_OF_PRAYER);
			DELAY_SPAWN_MONSTERS_DARK_WATER_DRAGON = Integer.parseInt(IOP.getProperty("IntervalOfSpawnDWD", "40000"));
			ISLE_OF_PRAYER_MIN_LV_TO_RACE = Integer.parseInt(IOP.getProperty("MinLvIOPR", "78"));
			DARK_CLOUD_MANSION_MAX_MEMBERS_IN_PT = Integer.parseInt(IOP.getProperty("DCMMaxPartyMembers", "2"));
			DARK_CLOUD_MANSION_MIN_LV = Integer.parseInt(IOP.getProperty("DCMMinLevel", "78"));
			CRYSTAL_CAVERNS_MIN_LV = Integer.parseInt(IOP.getProperty("CCMinLv", "78"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + ISLE_OF_PRAYER + " File.");
		}
		
		// NORNILS GARDEN
		try
		{
			L2Properties NG = new L2Properties(NORNILS_GARDEN);
			NORNILS_GARDEN_MIN_LV = Integer.parseInt(NG.getProperty("NGMinLv", "18"));
			NORNILS_GARDEN_MAX_LV = Integer.parseInt(NG.getProperty("NGMaxLv", "22"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + NORNILS_GARDEN + " File.");
		}
		
		// KAMALOKA
		try
		{
			L2Properties KM = new L2Properties(KAMALOKA);
			KAMALOKA_RESET_HOUR = Integer.parseInt(KM.getProperty("KRH", "6"));
			KAMALOKA_RESET_MIN = Integer.parseInt(KM.getProperty("KRM", "30"));
			KAMALOKA_EMPTY_DESTROY_TIME = Integer.parseInt(KM.getProperty("KEDT", "5"));
			KAMALOKA_EXIT_TIME = Integer.parseInt(KM.getProperty("KET", "5"));
			KAMALOKA_MAX_LEVEL_DIFFERENCE = Integer.parseInt(KM.getProperty("KMLD", "5"));
			KAMALOKA_STEALTH_SHAMAN = Boolean.parseBoolean(KM.getProperty("KSS", "false"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + KAMALOKA + " File.");
		}
		
		// CHAMBER OF DELUSION
		try
		{
			L2Properties COD = new L2Properties(CHAMBER_OF_DELUSION);
			CHAMBER_OF_DELUSION_MIN_LV = Integer.parseInt(COD.getProperty("CODMinLv", "80"));
			CHAMBER_OF_DELUSION_ROOM_CHANGE_INTERVAL = Integer.parseInt(COD.getProperty("CODIntChange", "480000"));
			CHAMBER_OF_DELUSION_ROOM_CHANGE_RANDOM_TIME = Integer.parseInt(COD.getProperty("CODRandomTime", "120"));
		}
		catch (Exception e)
		{
			e.printStackTrace();
			throw new Error("Failed to Load " + CHAMBER_OF_DELUSION + " File.");
		}
		
		// SSQ
		try
		{
			L2Properties SSQ = new L2Properties(SSQCFG);
		...
		try
		{
			L2Properties VAN_HALTER = new L2Properties(VAN_HALTER_PRIEST);
		...
		try
		{
			L2Properties ANTHARAS_CFG = new L2Properties(ANTHARAS);
			SPECIFIC_TIME_TO_ENTER_ANTHARAS = Boolean.parseBoolean(ANTHARAS_CFG.getProperty("SpecidicTimeAntharas", "false"));
			ANTHARAS_ALLOW_MIN_HOUR = Integer.parseInt(ANTHARAS_CFG.getProperty("MinTimeHoursEnter", "20"));
			ANTHARAS_ALLOW_MAX_HOUR = Integer.parseInt(ANTHARAS_CFG.getProperty("MaxTimeHoursEnter", "23"));
		...
		try
		{
			L2Properties ORFEN_CFG = new L2Properties(ORFEN);
		...
		try
		{
			L2Properties QUEEN_ANT_CFG = new L2Properties(QUEEN_ANT);
	...
	{
		_log.info(getText("LS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLQ=="));
		_log.info(getText("ICAgICAgICAgICAgICAgICAgICAgICAgUHJpdmF0ZSBEZXZlbG9wbWVudCBUZWFtICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgIA=="));
		_log.info(getText("ICAgICAgICAgICAgICAgICAgICAgICAgICAgICBDbGllbnQ6IEZyZXlhICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgIA=="));
		_log.info(getText("ICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgIDIwMTYtMjAxOSAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgIA=="));
		_log.info(getText("ICAgICAgICAgICAgICAgICBodHRwOi8vbDJqcHJpdmF0ZS1kZXZlbG9wZXJzLXRlYW0uZXUgICAgICAgICAgICAgICAgICAgICAgICAgIA=="));
		_log.info(getText("ICAgICAgICAgICAgICAgICAgICAgICAgICAgICBSZXZpc2lvbjogRnJlZSAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICAgICA="));
		_log.info(getText("LS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLS0tLQ=="));
	}
