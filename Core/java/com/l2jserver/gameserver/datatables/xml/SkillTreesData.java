 ...
 */
package com.l2jserver.gameserver.datatables.xml;
...
public final class SkillTreesData
{
	...
	private static final Map<ClassId, Map<Integer, L2SkillLearn>> _classSkillTrees = new LinkedHashMap<>();
	private static final Map<ClassId, Map<Integer, L2SkillLearn>> _transferSkillTrees = new LinkedHashMap<>();
	 ...
	 */
	private static final Map<ClassId, ClassId> _parentClassMap = new LinkedHashMap<>();
	...
	public void load()
	{
		...
		_log.info("Loaded " + classSkillTreeCount + "  Class Skills for " + _classSkillTrees.size() + " Class Skill Trees.");
		_log.info("Loaded " + _subClassSkillTree.size() + " Sub-Class Skills.");
		_log.info("Loaded " + trasferSkillTreeCount + " Transfer Skills for " + _transferSkillTrees.size() + " Transfer Skill Trees.");
		_log.info("Loaded " + _fishingSkillTree.size() + " Fishing Skills, " + fishingDwarvenSkillCount + " Dwarven only Fishing Skills.");
		_log.info("Loaded " + _collectSkillTree.size() + " Collect Skills.");
		_log.info("Loaded " + _pledgeSkillTree.size() + " Pledge Skills, " + (_pledgeSkillTree.size() - residentialSkillCount) + " for Pledge and " + residentialSkillCount + " Residential.");
		_log.info("Loaded " + _subPledgeSkillTree.size() + " Sub-Pledge Skills.");
		_log.info("Loaded " + _transformSkillTree.size() + " Transform Skills.");
		final int commonSkills = _commonSkillTree.size();
		if (commonSkills > 0)
		{
			_log.info("Loaded " + commonSkills + " Common Skills to all classes.");
		}
	}
	...
	{
		final List<L2SkillLearn> result = new ArrayList<>();
		final Map<Integer, L2SkillLearn> skills = new HashMap<>();
	...
	{
		final List<L2SkillLearn> result = new ArrayList<>();
		final Map<Integer, L2SkillLearn> skills = _transformSkillTree;
	...
	{
		final List<L2SkillLearn> result = new ArrayList<>();
		final Map<Integer, L2SkillLearn> skills = _pledgeSkillTree;
	...
	{
		final List<L2SkillLearn> result = new ArrayList<>();
		final Map<Integer, L2SkillLearn> skills = _subPledgeSkillTree;
	...
	{
		final List<L2SkillLearn> result = new ArrayList<>();
		final Map<Integer, L2SkillLearn> skills = _subClassSkillTree;
