...
public class SpawnTable
{
	...
	public void load()
	{
		if (!Config.ALT_DEV_NO_SPAWNS)
		{
			...
			_log.info("Loaded " + spawnCount + " npc spawns.");
			_log.info("Loaded " + (_spawnTable.size() - spawnCount) + " custom npc spawns.");
		}
	}
	...
	private void fillSpawnTable()
	{
		...
		if (Config.CUSTOM_SPAWNLIST_TABLE)
		{
			...
			_log.info("Loaded " + _customSpawnCount + " Npc Spawn Locations.");
			
		}
		
		if (Config.DEBUG)
		{
			_log.fine("Spawning completed, total number of NPCs in the world: " + (_npcSpawnCount + _customSpawnCount));
		}
