...
public class AdminCommandAccessRights
{
	...
	private void loadAdminCommandAccessRights()
	{
		...
		{
			_log.log(Level.WARNING, "Admin Command Access Rights: Error loading from database:" + e.getMessage(), e);
		}
		_log.info("Loaded " + _adminCommandAccessRights.size() + " admin commands from database.");
	}
	...
	public boolean hasAccess(String adminCommand, L2AccessLevel accessLevel)
	{
		...
		if (acar == null)
		{
			_log.info("Admin Command Access Rights: No rights defined for admin command " + adminCommand + ".");
			return false;
		}
	...
	public boolean requireConfirm(String command)
	{
		...
		if (acar == null)
		{
			_log.info("Admin Command Access Rights: No rights defined for admin command " + command + ".");
			return false;
		}
