...
import com.l2jserver.gameserver.communitybbs.Managers.GMReportFromPlayer;
...
public class CommunityBoard
{
	...
	public void handleCommands(L2GameClient client, String command)
	{
		...
		else if (command.startsWith("_bbsreportbugbot"))
		{
			GMReportFromPlayer.getInstance().parsecmd(command, activeChar);
		}
		else if (command.startsWith("_bbsgmview;"))
		{
			if (activeChar.isGM())
			{
				GMReportFromPlayer.getInstance().parsecmd(command, activeChar);
			...
			{
				activeChar.sendMessage("You are not allowed to visit this page. Its only for GM.");
				return;
			}
		}
		...
		else if (command.startsWith("_bbsdressme;"))
		{
			if (Config.ALLOW_DRESS_ME_SYSTEM)
			{
				DressMeBBSManager.getInstance().parsecmd(command, activeChar);
			}
			else
			{
				activeChar.sendMessage("You cant use this service!");
	...
	public void handleWriteCommands(L2GameClient client, String url, String arg1, String arg2, String arg3, String arg4, String arg5)
	{
		...
		if (Config.ENABLE_COMMUNITY_BOARD)
		{
			if (url.equals("Topic"))
			{
				MessageBoxBBSManager.getInstance().parsewrite(arg1, arg2, arg3, arg4, arg5, activeChar);
			}
