...
public class PartyMatchingBBSManager extends BaseBBSManager
{
	...
	{
		String content = HtmCache.getInstance().getHtm(activeChar, "data/html/CommunityBoard/Home.htm").replace("%partyMatchingMembers%", PartyMatchingBoard.getInstance().loadPartyMatchingMembersList(activeChar));
