...
public class RegionBBSManager extends BaseBBSManager
{
	...
	{
		String html = HtmCache.getInstance().getHtm(activeChar, "data/html/CommunityBoard/online.htm");
		...
		html = html.replace("%count%", Integer.toString(L2World.getInstance().getAllPlayersCount()));
