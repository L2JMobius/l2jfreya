...
public class ClanMailBBSManager extends BaseBBSManager
{
	...
	public void parsecmd(String command, L2PcInstance activeChar)
	{
		...
		String html = HtmCache.getInstance().getHtm(activeChar, "data/html/CommunityBoard/clanMails_list.htm");
		...
		else if (events[1].equals("writenew"))
		{
			if (activeChar.getClan() != null)
			{
				...
				{
					html = HtmCache.getInstance().getHtm(activeChar, "data/html/CommunityBoard/clanMails_new.htm");
				}
			}
		}
		...
		else if (events[1].equals("read"))
		{
			if ((activeChar.getClan() != null) && (events.length == 3))
			{
				...
				html = HtmCache.getInstance().getHtm(activeChar, "data/html/CommunityBoard/clanMail.htm");
