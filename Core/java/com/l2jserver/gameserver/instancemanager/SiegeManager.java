...
public class SiegeManager
{
	...
	private Map<Integer, List<SiegeSpawn>> _flameTowerSpawnList;
	...
	private final void load()
	{
		try (InputStream is = new FileInputStream(new File(Config.SIEGE)))
		{
			...
			_flameTowerSpawnList = new HashMap<>();
	...
	public final List<SiegeSpawn> getFlameTowerSpawnList(int _castleId)
	{
