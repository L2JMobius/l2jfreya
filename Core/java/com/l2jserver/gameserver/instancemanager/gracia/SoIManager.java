...
public class SoIManager
{
	...
	protected SoIManager()
	{
		...
		_log.info("Stage Level: " + getCurrentStage());
		_log.info("Cohemenes Kills: " + getCohemenesCount());
		_log.info("Ekimus Kills: " + getEkimusCount());
		_log.info("HoE Defense Count:" + getHoEDefCount());
	}
