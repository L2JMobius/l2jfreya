...
public final class UserInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		if (_airShipHelm == 0)
		{
			...
			{
				if (_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_RHAND) == 0)
				{
			...
			else if (!_activeChar.isDressMeEnabled())
			{
				writeD(_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_RHAND));
			}
		...
		if (_activeChar.isDressMeEnabled())
		{
			if (_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_GLOVES) == 0)
			{
			...
			if ((_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_CHEST) == 0) || (_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_LEGS) == 0))
			{
			...
			if (_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_FEET) == 0)
			{
			...
			if (_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_CLOAK) == 0)
			{
				writeD(_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_CLOAK));
			}
			else
			{
				writeD(_activeChar.getDressMeData() == null ? _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_CLOAK) : (_activeChar.getDressMeData().getCloakId() == 0 ? _activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_CLOAK) : _activeChar.getDressMeData().getCloakId()));
			}
		}
		else if (!_activeChar.isDressMeEnabled())
		{
		...
		// writeD(_activeChar.getInventory().getPaperdollObjectId(Inventory.PAPERDOLL_RHAND));//TODO?
		...
		if (_airShipHelm == 0)
		{
			if (_activeChar.isDressMeEnabled())
			{
				if (_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_RHAND) == 0)
				{
		...
		if (_activeChar.isDressMeEnabled())
		{
			if (_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_GLOVES) == 0)
			{
			...
			if ((_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_CHEST) == 0) || (_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_LEGS) == 0))
			{
			...
			if (_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_FEET) == 0)
			{
			...
			if (_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_CLOAK) == 0)
			{
				writeD(_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_CLOAK));
			}
			else
			{
				writeD(_activeChar.getDressMeData() == null ? _activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_CLOAK) : (_activeChar.getDressMeData().getCloakId() == 0 ? _activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_CLOAK) : _activeChar.getDressMeData().getCloakId()));
			}
		}
		else if (!_activeChar.isDressMeEnabled())
		{
		...
		// writeD(_activeChar.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_RHAND));//TODO: ?
		...
		else
		{
			...
			{
				writeF(_activeChar.getDressMeData().getRadius());
				writeF(_activeChar.getDressMeData().getHeight());
			}
		}
		...
		{
			writeD(_activeChar.getDressMeData().getTransformId());
		}
		...
		{
			writeD(_activeChar.getDressMeData().getAgathionId());
		}
