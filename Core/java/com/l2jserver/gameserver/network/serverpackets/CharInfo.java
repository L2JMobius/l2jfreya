...
public class CharInfo extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		else
		{
			...
			// writeD(_inv.getPaperdollItemId(Inventory.PAPERDOLL_RHAND));// TODO?
			...
			if (_airShipHelm == 0)
			{
				if (_activeChar.isDressMeEnabled())
				{
					if (_activeChar.getInventory().getPaperdollAugmentationId(Inventory.PAPERDOLL_RHAND) == 0)
					{
						writeD(_inv.getPaperdollAugmentationId(Inventory.PAPERDOLL_RHAND));
					}
					else
					{
						writeD(_activeChar.getDressMeData() == null ? _activeChar.getInventory().getPaperdollAugmentationId(Inventory.PAPERDOLL_RHAND) : (_activeChar.getDressMeData().getWeapId() == 0 ? _activeChar.getInventory().getPaperdollAugmentationId(Inventory.PAPERDOLL_RHAND) : _activeChar.getDressMeData().getWeapId()));
					}
				}
				else if (!_activeChar.isDressMeEnabled())
				{
