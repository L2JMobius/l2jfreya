	...
	protected void runImpl()
	{
		...
		switch (skillType)
		{
			...
			case SubClass:
			{
				...
				QuestState st = activeChar.getQuestState(SubClassSkills.class.getSimpleName());
				if (st == null)
				{
					final Quest subClassSkilllsQuest = QuestManager.getInstance().getQuest(SubClassSkills.class.getSimpleName());
