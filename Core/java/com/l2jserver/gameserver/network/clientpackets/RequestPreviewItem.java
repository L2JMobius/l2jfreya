...
public final class RequestPreviewItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if (!_activeChar.isGM() && ((target == null // No target (ie GM Shop)
			...
			|| !_activeChar.isInsideRadius(target, Config.INTERACTION_DISTANCE_NPC, false, false) // Distance is too far
		))
		{
			return;
		}
		...
		List<L2TradeList> lists = BuyListTable.getInstance().getBuyListByNpcId(merchant.getNpcId());
