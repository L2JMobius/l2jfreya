...
public class Shutdown extends Thread
{
	...
	private void saveData()
	{
		...
		BuyListTable.getInstance().dataCountStore();
		...
		// Save Clan WareHouse items if server using lazyItemsUpdate mod
		ClanTable.getInstance().stopUpdateCLanWarehouseTask();
		_log.info("ClanTable: Clanhouses data saved");
		...
		// Buff Shop Dummies
		BuffShopManager.getInstance().storeOffliners();
		BuffShopManager.getInstance().sendOffLinePrice();
