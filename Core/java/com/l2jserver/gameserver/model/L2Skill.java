...
public abstract class L2Skill implements IChanceSkillTrigger
{
	...
	protected L2Skill(StatsSet set)
	{
		...
		if (this.getId() < 1000)
		{
			_icon = set.getString("icon", "icon.skill0" + _id);
		}
		else
		{
			_icon = set.getString("icon", "icon.skill" + _id);
		}
	 ...
	 * @return
	 */
	public static L2Skill valueOf(int i, int j)
	{
		return SkillTable.getInstance().getSkill(i, j);
	}
