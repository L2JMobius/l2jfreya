...
public class L2TvTEventNpcInstance extends L2Npc
{
	...
	public void showChatWindow(L2PcInstance playerInstance, int val)
	{
		...
		if (TvTEvent.isParticipating())
		{
			...
			if (!isParticipant)
			{
				htmContent = HtmCache.getInstance().getHtm(playerInstance, htmlPath + "Participation.htm");
			}
			else
			{
				htmContent = HtmCache.getInstance().getHtm(playerInstance, htmlPath + "RemoveParticipation.htm");
			}
		...
		{
			final String htmContent = HtmCache.getInstance().getHtm(playerInstance, htmlPath + "Status.htm");
