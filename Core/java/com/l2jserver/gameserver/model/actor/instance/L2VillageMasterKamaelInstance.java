...
import com.l2jserver.scripts.quests.Q00234_FatesWhisper;
import com.l2jserver.scripts.quests.Q00236_SeedsOfChaos;
...
public final class L2VillageMasterKamaelInstance extends L2VillageMasterInstance
{
	...
	protected final boolean checkQuests(L2PcInstance player)
	{
		...
		QuestState qs = player.getQuestState(Q00234_FatesWhisper.class.getSimpleName());
		if ((qs == null) || !qs.isCompleted())
		{
			return false;
		}
		
		qs = player.getQuestState(Q00236_SeedsOfChaos.class.getSimpleName());
		if ((qs == null) || !qs.isCompleted())
		{
			return false;
		}
