...
public class L2CastleChamberlainInstance extends L2MerchantInstance
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		else if (condition == COND_OWNER)
		{
			...
			if (actualCommand.equalsIgnoreCase("banish_foreigner"))
			{
				...
				html.setFile(player, "data/html/chamberlain/chamberlain-banishafter.htm");
				html.replace("%objectId%", String.valueOf(getObjectId()));
				player.sendPacket(html);
				return;
			}
			else if (actualCommand.equalsIgnoreCase("banish_foreigner_show"))
			{
				...
				NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player, "data/html/chamberlain/chamberlain-banishfore.htm");
				html.replace("%objectId%", String.valueOf(getObjectId()));
				player.sendPacket(html);
				return;
			}
			else if (actualCommand.equalsIgnoreCase("list_siege_clans"))
			{
				...
				NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player, "data/html/chamberlain/chamberlain-noprivs.htm");
				player.sendPacket(html);
				return;
			}
			...
			else if (actualCommand.equalsIgnoreCase("receive_report"))
			{
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player, "data/html/chamberlain/chamberlain-report.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
			...
			// control
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_OPEN_DOOR) == L2Clan.CP_CS_OPEN_DOOR)
				{
					...
					NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player, "data/html/chamberlain/" + getTemplate().npcId + "-d.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					html.replace("%npcname%", getName());
					player.sendPacket(html);
					return;
			...
			// control
			{
				...
				NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player, "data/html/chamberlain/chamberlain-tax.htm");
				html.replace("%objectId%", String.valueOf(getObjectId()));
			...
			{
				NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player, "data/html/chamberlain/chamberlain-manage.htm");
				html.replace("%objectId%", String.valueOf(getObjectId()));
				player.sendPacket(html);
				return;
			}
			...
			{
				NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(player, "data/html/chamberlain/chamberlain-products.htm");
				html.replace("%objectId%", String.valueOf(getObjectId()));
				html.replace("%npcId%", String.valueOf(getNpcId()));
				player.sendPacket(html);
				return;
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				if (val.equalsIgnoreCase("tele"))
				{
					...
					{
						html.setFile(player, "data/html/chamberlain/chamberlain-nac.htm");
					}
					else
					{
						html.setFile(player, "data/html/chamberlain/" + getNpcId() + "-t" + getCastle().getFunction(Castle.FUNC_TELEPORT).getLvl() + ".htm");
					}
				...
				else if (val.equalsIgnoreCase("support"))
				{
					...
					{
						html.setFile(player, "data/html/chamberlain/support" + getCastle().getFunction(Castle.FUNC_SUPPORT).getLvl() + ".htm");
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile(player, "data/html/chamberlain/chamberlain-functions.htm");
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CS_SET_FUNCTIONS) == L2Clan.CP_CS_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							{
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player, "data/html/chamberlain/functions-cancel.htm");
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								val = st.nextToken();
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player, "data/html/chamberlain/functions-apply.htm");
							...
							else if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									val = st.nextToken();
									NpcHtmlMessage html = new NpcHtmlMessage(1);
									html.setFile(player, "data/html/chamberlain/functions-apply_confirmed.htm");
									if (getCastle().getFunction(Castle.FUNC_RESTORE_HP) != null)
									{
										if (getCastle().getFunction(Castle.FUNC_RESTORE_HP).getLvl() == Integer.parseInt(val))
										{
											html.setFile(player, "data/html/chamberlain/functions-used.htm");
									...
									switch (percent)
									{
										case 0:
											fee = 0;
											html.setFile(player, "data/html/chamberlain/functions-cancel_confirmed.htm");
											break;
										case 80:
									...
									{
										html.setFile(player, "data/html/chamberlain/low_adena.htm");
										sendHtmlMessage(player, html);
									}
									sendHtmlMessage(player, html);
								}
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, "data/html/chamberlain/edit_recovery.htm");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, "data/html/chamberlain/edit_other.htm");
					...
					{
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, "data/html/chamberlain/manage.htm");
						sendHtmlMessage(player, html);
					}
				}
				else
				...
				try
				{
					...
					try
					{
						...
						else
						{
							...
							{
								html.setFile(player, "data/html/chamberlain/support-no_mana.htm");
								html.replace("%mp%", String.valueOf((int) getCurrentMp()));
								sendHtmlMessage(player, html);
								return;
							}
						}
						html.setFile(player, "data/html/chamberlain/support-done.htm");
						html.replace("%mp%", String.valueOf((int) getCurrentMp()));
						sendHtmlMessage(player, html);
					}
					catch (Exception e)
			...
			else if (actualCommand.equalsIgnoreCase("siege_change")) // siege day set
			{
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile(player, "data/html/chamberlain/chamberlain-noadmin.htm");
					sendHtmlMessage(player, html);
				}
				else if (player.isClanLeader())
				{
					...
					{
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, "data/html/chamberlain/siegetime1.htm");
						sendHtmlMessage(player, html);
					}
					else if (getCastle().getSiege().getIsTimeRegistrationOver())
					{
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, "data/html/chamberlain/siegetime2.htm");
						sendHtmlMessage(player, html);
					}
					else
					{
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player, "data/html/chamberlain/siegetime3.htm");
			...
			else if (actualCommand.equalsIgnoreCase("siege_time_set")) // set preDay
			{
				...
				NpcHtmlMessage html = getNextSiegeTimePage(player, Integer.parseInt(val), isAfternoon);
				...
				if (html == null)
				{
					...
					html.setFile(player, "data/html/chamberlain/siegetime8.htm");
					html.replace("%time%", String.valueOf(getCastle().getSiegeDate().getTime()));
				}
				sendHtmlMessage(player, html);
				return;
			...
			else if (actualCommand.equals("give_crown"))
			{
				...
				if (player.isClanLeader())
				{
					if (player.getInventory().getItemByItemId(6841) == null)
					{
						...
						html.setFile(player, "data/html/chamberlain/chamberlain-gavecrown.htm");
						html.replace("%CharName%", String.valueOf(player.getName()));
						html.replace("%FeudName%", String.valueOf(getCastle().getName()));
					}
					else
					{
						html.setFile(player, "data/html/chamberlain/chamberlain-hascrown.htm");
					}
				}
				else
				{
	...
	private NpcHtmlMessage getNextSiegeTimePage(L2PcInstance player, int now, boolean isAfternoon)
	{
		NpcHtmlMessage ret = new NpcHtmlMessage(1);
		if ((now == 0) && Config.CL_SET_SIEGE_TIME_LIST.contains("day"))
		{
			ret.setFile(player, "data/html/chamberlain/siegetime4.htm");
			return ret;
		}
		if ((now < 3) && Config.CL_SET_SIEGE_TIME_LIST.contains("hour"))
		{
			switch (now)
			{
				...
				case 1:
					...
					{
						ret.setFile(player, "data/html/chamberlain/siegetime5.htm");
						return ret;
					}
				case 2:
					ret.setFile(player, "data/html/chamberlain/siegetime6.htm");
					List<Integer> list;
					int inc = 0;
					String ampm = "";
		...
		{
			ret.setFile(player, "data/html/chamberlain/siegetime7.htm");
			return ret;
		}
	...
	private boolean siegeBlocksFunction(L2PcInstance player)
	{
		...
		{
			NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
			html.setFile(player, "data/html/chamberlain/chamberlain-busy.htm");
