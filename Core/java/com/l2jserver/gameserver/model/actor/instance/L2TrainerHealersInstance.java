...
public final class L2TrainerHealersInstance extends L2TrainerInstance
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		if (command.equals("SkillTransfer_Learn"))
		{
			...
			{
				html.setFile(player, "data/html/trainer/skilltransfer/learn-lowlevel.htm");
		...
		else if (command.equals("SkillTransfer_Cleanse"))
		{
			...
			if ((player.getLevel() < 76) || (player.getClassId().level() < 3))
			{
				html.setFile(player, "data/html/trainer/skilltransfer/cleanse-no.htm");
				player.sendPacket(html);
				return;
			}
			...
			else
			{
				...
				html.setFile(player, "data/html/trainer/skilltransfer/cleanse-no_skills.htm");
				player.sendPacket(html);
			}
		}
		else
