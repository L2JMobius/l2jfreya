...
public final class L2ClanTraderInstance extends L2Npc
{
	...
	public void onBypassFeedback(L2PcInstance player, String command)
	{
		...
		if (command.equalsIgnoreCase("crp"))
		{
			...
			{
				html.setFile(player, "data/html/clantrader/" + getNpcId() + "-2.htm");
			}
			else
			{
				html.setFile(player, "data/html/clantrader/" + getNpcId() + "-1.htm");
			}
		...
		else if (command.startsWith("exchange"))
		{
			...
			if (playerItemCount >= itemCount)
			{
				...
				html.setFile(player, "data/html/clantrader/" + getNpcId() + "-ExchangeSuccess.htm");
			}
			else
			{
				html.setFile(player, "data/html/clantrader/" + getNpcId() + "-ExchangeFailed.htm");
			}
