...
public class L2NpcBufferInstance extends L2Npc
{
	...
	private static Map<Integer, Integer> pageVal = new HashMap<>();
	...
	public void showChatWindow(L2PcInstance playerInstance, int val)
	{
		...
		String htmContent = HtmCache.getInstance().getHtm(playerInstance, "data/html/mods/NpcBuffer.htm");
		
		if (val > 0)
		{
			htmContent = HtmCache.getInstance().getHtm(playerInstance, "data/html/mods/NpcBuffer-" + val + ".htm");
		}
