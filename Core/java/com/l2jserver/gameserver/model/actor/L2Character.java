...
public abstract class L2Character extends L2Object
{
	...
	private final List<L2Effect> _lastCancelledEffects = new ArrayList<>();
	...
	public static final byte BUFF_SHOP = 23;
	...
	public void disableSkill(L2Skill skill, long delay)
	{
		...
		{
			_disabledSkills = Collections.synchronizedMap(new HashMap<>());
		}
	...
	public final int setSTR(int val)
	{
		return getTemplate().baseSTR = val;
	}
	...
	public final int setINT(int val)
	{
		return getTemplate().baseINT = val;
	}
	...
	public final int setDEX(int val)
	{
		return getTemplate().baseDEX = val;
	}
	...
	public final int setWIT(int val)
	{
		return getTemplate().baseWIT = val;
	}
	...
	public final int setCON(int val)
	{
		return getTemplate().baseCON = val;
	}
	...
	public final int setMEN(int val)
	{
		return getTemplate().baseMEN = val;
	}
	...
	public void reduceCurrentHp(double i)
	{
	...
	public final int setCurrentRadius(int val)
	{
		return getTemplate().collisionHeight = val;
	}
	
	public final int setCurrentHeight(int val)
	{
		return getTemplate().collisionHeight = val;
	}
	...
	public void recoverLastCancelledEffects()
	{
		...
		_lastCancelledEffectsTask = ThreadPoolManager.getInstance().scheduleGeneral(() ->
		{
	...
	{
		return _effects.isAffected(skillId);
	}
}
