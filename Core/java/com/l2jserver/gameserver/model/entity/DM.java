...
public class DM
{
	...
	public static void loadData()
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement = con.prepareStatement("Select * from dm"))
		{
	...
	{
		try (Connection con = L2DatabaseFactory.getInstance().getConnection();
			PreparedStatement statement1 = con.prepareStatement("Delete from dm");
			PreparedStatement statement2 = con.prepareStatement("INSERT INTO dm (eventName, eventDesc, joiningLocation, minlvl, maxlvl, npcId, npcX, npcY, npcZ, rewardId, rewardAmount, color, playerX, playerY, playerZ ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"))
		{
			statement1.execute();
			
			statement2.setString(1, _eventName);
			statement2.setString(2, _eventDesc);
			statement2.setString(3, _joiningLocationName);
			statement2.setInt(4, _minlvl);
			statement2.setInt(5, _maxlvl);
			statement2.setInt(6, _npcId);
			statement2.setInt(7, _npcX);
			statement2.setInt(8, _npcY);
			statement2.setInt(9, _npcZ);
			statement2.setInt(10, _rewardId);
			statement2.setInt(11, _rewardAmount);
			statement2.setInt(12, _playerColors);
			statement2.setInt(13, _playerX);
			statement2.setInt(14, _playerY);
			statement2.setInt(15, _playerZ);
			statement2.execute();
		}
		catch (Exception e)
		{
