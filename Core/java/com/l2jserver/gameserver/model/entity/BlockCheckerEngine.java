...
public final class BlockCheckerEngine
{
	...
	protected final Map<L2PcInstance, Integer> _redTeamPoints = new ConcurrentHashMap<>();
	protected final Map<L2PcInstance, Integer> _blueTeamPoints = new ConcurrentHashMap<>();
	...
	// All blocks
	protected final List<L2Spawn> _spawns = new CopyOnWriteArrayList<>();
	...
	protected final List<L2ItemInstance> _drops = new ArrayList<>();
	// Default arena
