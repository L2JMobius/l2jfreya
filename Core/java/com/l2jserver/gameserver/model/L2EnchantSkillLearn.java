...
public final class L2EnchantSkillLearn
{
	...
	private final Map<Integer, Integer> _enchantRoutes = new HashMap<>();
	...
	{
		return EnchantGroupsTable.getInstance().getEnchantSkillGroupById(_enchantRoutes.values().stream().findFirst().get());
	}
