...
public class PlayerVariables extends AbstractVariables
{
	...
	public static final String PC_POINT = "pcCafe_point";
	...
	public static PlayerVariables getInstance()
	{
	...
	{
		protected static final PlayerVariables _instance = new PlayerVariables(_objectId);
	}
