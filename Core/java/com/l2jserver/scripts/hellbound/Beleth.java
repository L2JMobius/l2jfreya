...
public class Beleth extends L2AttackableAIScript
{
	...
	// Configs
	private static final long WAIT_TIME_BELETH = Config.BELETH_WAIT_TIME;
			...
			try
			{
				switch (_taskId)
				{
					...
					case 3:
						...
						break;
					case 4:
						broadcastPacket(new SpecialCamera(_CAMERA2.getObjectId(), 2200, 130, 0, 0, 1500, -20, 15, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(5), 1400);
						break;
					case 5:
						broadcastPacket(new SpecialCamera(_CAMERA2.getObjectId(), 2300, 100, 0, 2000, 4500, 0, 10, 1, 0));
					...
					case 6:
						...
						break;
					case 7:
						broadcastPacket(new SpecialCamera(_CAMERA4.getObjectId(), 1500, 210, 0, 0, 1500, 0, 0, 1, 0));
						broadcastPacket(new SpecialCamera(_CAMERA4.getObjectId(), 900, 255, 0, 5000, 6500, 0, 10, 1, 0));
					...
					case 8:
						...
						broadcastPacket(new SpecialCamera(_CAMERA4.getObjectId(), 900, 255, 0, 0, 1500, 0, 10, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(9), 1000);
						break;
					case 9:
						broadcastPacket(new SpecialCamera(_CAMERA4.getObjectId(), 1000, 255, 0, 7000, 17000, 0, 25, 1, 0));
					...
					case 11:
						...
						break;
					case 12:
						broadcastPacket(new SpecialCamera(_BELETH.getObjectId(), 0, 270, -5, 0, 4000, 0, 0, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(13), 3500);
						break;
					case 13:
						broadcastPacket(new SpecialCamera(_BELETH.getObjectId(), 800, 270, 10, 3000, 6000, 0, 0, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(14), 5000);
						break;
					case 14:
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 100, 270, 15, 0, 5000, 0, 0, 1, 0));
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 100, 270, 15, 0, 5000, 0, 0, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(15), 100);
						break;
					case 15:
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 100, 270, 15, 3000, 6000, 0, 5, 1, 0));
					...
					case 17:
						...
						break;
					case 18:
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 700, 270, 20, 1500, 8000, 0, 0, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(19), 6900);
						break;
					case 19:
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 40, 260, 0, 0, 4000, 0, 0, 1, 0));
						...
						break;
					case 20:
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 40, 280, 0, 0, 4000, 5, 0, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(21), 3000);
						break;
					case 21:
						broadcastPacket(new SpecialCamera(_CAMERA3.getObjectId(), 5, 250, 5, 0, 13000, 20, 15, 1, 0));
					...
					case 27:
						...
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 400, 290, 25, 0, 10000, 0, 0, 1, 0));
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 400, 290, 25, 0, 10000, 0, 0, 1, 0));
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 400, 110, 25, 4000, 10000, 0, 0, 1, 0));
						broadcastPacket(new SocialAction(_BELETH, 5));
						
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(28), 4000);
						break;
					case 28:
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 400, 295, 25, 4000, 5000, 0, 0, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(29), 4500);
						break;
					case 29:
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 400, 295, 10, 4000, 11000, 0, 25, 1, 0));
						ThreadPoolManager.getInstance().scheduleGeneral(new Spawn(30), 9000);
						break;
					case 30:
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 250, 90, 25, 0, 1000, 0, 0, 1, 0));
						broadcastPacket(new SpecialCamera(_CAMERA.getObjectId(), 250, 90, 25, 0, 10000, 0, 0, 1, 0));
					...
					case 31:
						...
						break;
					case 32:
						broadcastPacket(new SpecialCamera(_CAMERA2.getObjectId(), 800, 180, 0, 0, 4000, 0, 10, 1, 0));
						broadcastPacket(new SpecialCamera(_CAMERA2.getObjectId(), 800, 180, 0, 0, 4000, 0, 10, 1, 0));
