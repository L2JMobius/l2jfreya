...
{
	//@formatter:off
	private static final int RESET_HOUR = Config.KAMALOKA_RESET_HOUR;
	private static final int RESET_MIN = Config.KAMALOKA_RESET_MIN;
	private static final int EMPTY_DESTROY_TIME = Config.KAMALOKA_EMPTY_DESTROY_TIME;
	private static final int EXIT_TIME =  Config.KAMALOKA_EXIT_TIME;
	private static final int MAX_LEVEL_DIFFERENCE =Config.KAMALOKA_MAX_LEVEL_DIFFERENCE;
	private static final boolean STEALTH_SHAMAN = Config.KAMALOKA_STEALTH_SHAMAN;
