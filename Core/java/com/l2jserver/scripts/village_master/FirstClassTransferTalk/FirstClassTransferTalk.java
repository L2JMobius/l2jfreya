 ...
 */
package com.l2jserver.scripts.village_master.FirstClassTransferTalk;
...
public final class FirstClassTransferTalk extends L2AttackableAIScript
{
	...
	public FirstClassTransferTalk()
	{
		...
		StartNpcs(BITZ, BIOTIN, ASTERIOS, THIFIELL, KAKAI, REED, BRONK, HOFFA, FISLER, MOKA, DEVON, RIVIAN, TOOK, PRANA, ALDENIA);
		TalkNpcs(BITZ, BIOTIN, ASTERIOS, THIFIELL, KAKAI, REED, BRONK, HOFFA, FISLER, MOKA, DEVON, RIVIAN, TOOK, PRANA, ALDENIA);
	}
