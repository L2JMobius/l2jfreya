package com.l2jserver.scripts.freya.IceQueensCastle;
...
import com.l2jserver.scripts.quests.Q10285_MeetingSirra;
...
public class IceQueensCastle extends Quest
{
	...
	protected int enterInstance(L2PcInstance player, String template, teleCoord teleto)
	{
		...
		{
			if (player.getLevel() < Config.ICE_QUEEN_CASTLE_QUEST_MIN_LV)
			{
				return 0;
			}
	...
	{
		List<L2Npc> npcList = new ArrayList<>();
		L2Npc victim = null;
