package com.l2jserver.scripts.l2jpdt_npcs.AutomaticTeleporterNPC;
...
public class AutomaticTeleporterNPC extends Quest
{
	...
	private void showAgain(L2PcInstance activeChar)
	{
		...
		html.setFile(activeChar, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/againTeleport.htm");
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		if (USE_TELEPORTER)
		{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/startingloc.htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/gracia.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/toi.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/freya.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/other.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/kingdoms.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/necropolis.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/catacombs.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/primeval.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/hellbound.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC//towns.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/aden.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/giran.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/goddard.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/rune.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/schuttgart.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/oren.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/dion.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/gludio.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/gludin.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/kingdoms/hunters.htm");
				player.sendPacket(html);
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/index.htm");
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%player%", player.getName());
				player.sendPacket(html);
			}
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/telmenu/showRegions.htm");
				html.replace("%player%", player.getName());
				html.replace("%itemname%", ITEM_NAME);
				html.replace("%itemcount%", ITEM_COUNT);
				player.sendPacket(html);
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/info1.htm");
				html.replace("%player%", player.getName());
				player.sendPacket(html);
			}
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/info2.htm");
				html.replace("%player%", player.getName());
				player.sendPacket(html);
			}
			else if (event.startsWith("savedLocation"))
			{
				...
				try (Connection con = L2DatabaseFactory.getInstance().getConnection())
				{
					...
					ShowHTML.setFile(player, "data/scripts/l2jpdt_npcs/AutomaticTeleporterNPC/savedLocation.htm");
