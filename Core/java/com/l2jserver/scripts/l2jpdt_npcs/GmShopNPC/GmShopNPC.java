package com.l2jserver.scripts.l2jpdt_npcs.GmShopNPC;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		if (USE_GM_SHOP)
		{
			if (event.startsWith("back"))
			{
				...
				html.setFile(player, "data/scripts/l2jpdt_npcs/GmShopNPC/index.htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/GmShopNPC/armors.htm");
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/GmShopNPC/weapons.htm");
				html.replace("%adena%", "" + player.getAdena());
				html.replace("%level%", "" + player.getLevel());
				if (player.getLevel() < 20)
				{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/GmShopNPC/jewels.htm");
				html.replace("%adena%", "" + player.getAdena());
				html.replace("%level%", "" + player.getLevel());
				if (player.getLevel() < 20)
				{
			...
			{
				final NpcHtmlMessage html = new NpcHtmlMessage(5);
				html.setFile(player, "data/scripts/l2jpdt_npcs/GmShopNPC/others.htm");
				html.replace("%adena%", "" + player.getAdena());
				html.replace("%player%", player.getName());
				player.sendPacket(html);
			}
