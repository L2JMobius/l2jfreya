...
public class HolyBrazier extends L2AttackableAIScript
{
	...
	public HolyBrazier()
	{
		...
		// Need rework
		startQuestTimer("monatery_start_12", 1000, null, null, false);
		startQuestTimer("monatery_start_11", 1000, null, null, false);
		startQuestTimer("monatery_start_10", 1000, null, null, false);
		startQuestTimer("monatery_start_9", 1000, null, null, false);
		startQuestTimer("monatery_start_8", 1000, null, null, false);
		startQuestTimer("monatery_start_7", 1000, null, null, false);
		startQuestTimer("monatery_start_6", 1000, null, null, false);
		startQuestTimer("monatery_start_5", 1000, null, null, false);
		startQuestTimer("monatery_start_4", 1000, null, null, false);
		startQuestTimer("monatery_start_3", 1000, null, null, false);
		startQuestTimer("monatery_start_2", 1000, null, null, false);
		startQuestTimer("monatery_start_1", 1000, null, null, false);
		
		_log.info("MoS AI: Spawning Holy Braziers on locations.");
	}
