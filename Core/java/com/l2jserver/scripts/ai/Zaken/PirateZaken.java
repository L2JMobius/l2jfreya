 ...
 */
package com.l2jserver.scripts.ai.Zaken;
...
public class PirateZaken extends L2AttackableAIScript
{
	protected class ZWorld extends InstanceWorld
	{
		List<L2PcInstance> _playersInInstance = new ArrayList<>();
		List<L2PcInstance> _playersInZakenZone = new ArrayList<>();
		int _zakenZone, _blueCandles = 0;
		L2Character _target;
		L2Attackable _zaken;
		...
		public List<L2Npc> _barrels = new ArrayList<>();
	...
	private static final Map<Integer, Integer[]> zoneBarrels = new HashMap<>();
	static
	{
	...
	private static final List<Location> _spawnPcLocationDaytime = new ArrayList<>();
	static
	{
	...
	private static final List<Location> _spawnPcLocationNighttime = new ArrayList<>();
	static
	{
	...
	private static final List<Location> _spawnsZaken = new ArrayList<>();
	static
	{
	...
	public PirateZaken()
	{
		super(-1, PirateZaken.class.getSimpleName(), "ai");
		
		StartNpcs(PATHFINDER);
		TalkNpcs(PATHFINDER);
		FirstTalkNpcs(PATHFINDER, BARREL);
	...
	private void teleportPlayer(L2PcInstance player, List<Location> spawnLoc, ZWorld world)
	{
