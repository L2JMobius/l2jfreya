...
public class DenOfEvil extends L2AttackableAIScript
{
	...
	private static final int[][] EYE_SPAWN_LOCATION =
	{
	...
	{
		for (int[] _spawn : EYE_SPAWN_LOCATION)
		{
			addSpawn(EYE_IDS[Rnd.get(0, EYE_IDS.length - 1)], _spawn[0], _spawn[1], _spawn[2], _spawn[3], false, 0);
		}
	}
	...
	private class RespawnNewEye implements Runnable
	{
		...
		public void run()
		{
			addSpawn(EYE_IDS[Rnd.get(0, EYE_IDS.length - 1)], _x, _y, _z, _h, false, 0);
		}
	}
