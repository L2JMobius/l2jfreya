 ...
 */
package com.l2jserver.scripts.events.HideAndSeek;
...
public class HideAndSeek extends Quest
{
	...
	private static final List<StatsSet> hideNpcs = new ArrayList<>();
	protected static final List<L2PcInstance> _players = new ArrayList<>();
