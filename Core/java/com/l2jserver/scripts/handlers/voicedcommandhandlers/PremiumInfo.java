		...
		if (Config.USE_PREMIUMSERVICE)
		{
			...
			
			{
				...
				if (activeChar.getPremiumService() == 0)
				{
					...
					html3.append("</table>");
					html3.append("<br><br><font name=hs12 color=\"LEVEL\">L2jPDT services</font></center></body></html>");
				...
				else if (activeChar.getPremiumService() == 1)
				{
					...
					StringBuilder html3 = new StringBuilder("<html><body><title>Premium Account</title><center>");
					html3.append("<table>");
