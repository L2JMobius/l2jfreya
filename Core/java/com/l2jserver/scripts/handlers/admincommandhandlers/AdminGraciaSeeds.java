...
public class AdminGraciaSeeds implements IAdminCommandHandler
{
	...
	/**
	 * @see com.l2jserver.gameserver.handler.interfaces.IAdminCommandHandler#useAdminCommand(java.lang.String, com.l2jserver.gameserver.model.actor.instance.L2PcInstance)
	 */
	@Override
	...
	private void showMenu(L2PcInstance activeChar)
	{
		...
		html.replace("%sodstate%", String.valueOf(SoDManager.getSoDState()));
	...
	/**
	 * @see com.l2jserver.gameserver.handler.interfaces.IAdminCommandHandler#getAdminCommandList()
	 */
	@Override
