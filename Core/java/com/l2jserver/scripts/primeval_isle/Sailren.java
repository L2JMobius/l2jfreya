package com.l2jserver.scripts.primeval_isle;
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npc.getNpcId() == STATUE)
		{
			if ((GrandBossManager.getInstance().getBossStatus(SAILREN) == DORMANT) || (GrandBossManager.getInstance().getBossStatus(SAILREN) == WAITING))
			{
				...
				else if (player.getQuestState(Sailren.class.getSimpleName()).hasQuestItems(8784))
				{
					player.getQuestState(Sailren.class.getSimpleName()).takeItems(8784, 1);
