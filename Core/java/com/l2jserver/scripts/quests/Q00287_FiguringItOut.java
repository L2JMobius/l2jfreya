...
public class Q00287_FiguringItOut extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(Q00287_FiguringItOut.class.getSimpleName());
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		final QuestState st = partyMember.getQuestState(Q00287_FiguringItOut.class.getSimpleName());
