...
public final class Q00511_AwlUnderFoot extends Quest
{
	...
	private String checkConditions(L2PcInstance player)
	{
		...
		{
			QuestState st = partyMember.getQuestState(Q00511_AwlUnderFoot.class.getSimpleName());
		...
		else
		{
			...
			else
			{
				for (L2PcInstance partyMember : party.getPartyMembers())
				{
					...
					if (partyMember.getQuestState(Q00511_AwlUnderFoot.class.getSimpleName()) == null)
					{
	...
	{
		QuestState st = player.getQuestState(Q00511_AwlUnderFoot.class.getSimpleName());
		if (st.getInt("cond") == 1)
		{
	...
	{
		super(511, Q00511_AwlUnderFoot.class.getSimpleName(), "quests");
