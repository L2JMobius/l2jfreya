...
public class TerritoryWarSuperClass extends Quest
{
	...
	public static void main(String[] args)
	{
		...
		TerritoryWarSuperClass wizards = new Q00736_Weakenmagic();
