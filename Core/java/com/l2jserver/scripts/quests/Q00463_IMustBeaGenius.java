...
public class Q00463_IMustBeaGenius extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		QuestState st = player.getQuestState(Q00463_IMustBeaGenius.class.getSimpleName());
