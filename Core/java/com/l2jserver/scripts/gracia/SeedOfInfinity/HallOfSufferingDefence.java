...
import com.l2jserver.scripts.quests.Q00695_DefendtheHallofSuffering;
import com.l2jserver.util.Rnd;

public class HallOfSufferingDefence extends SeedOfInfinityController
{
	private class DHSWorld extends InstanceWorld
	{
		public Map<L2Npc, Boolean> npcList = new HashMap<>();
		public List<L2Npc> tumor = new ArrayList<>();
		...
		protected void calcRewardItemId()
		{
			...
			{
				tag = SeedOfInfinityController.JEWEL_ORNAMENTED_DUEL_SUPPLIES;
			}
			else if (finishDiff < 1380000)
			{
				tag = SeedOfInfinityController.MOTHER_OF_PEARL_ORNAMENTED_DUEL_SUPPLIES;
			}
			else if (finishDiff < 1500000)
			{
				tag = SeedOfInfinityController.GOLD_ORNAMENTED_DUEL_SUPPLIES;
			}
			else if (finishDiff < 1620000)
			{
				tag = SeedOfInfinityController.SILVER_ORNAMENTED_DUEL_SUPPLIES;
			}
			else if (finishDiff < 1740000)
			{
				tag = SeedOfInfinityController.BRONZE_ORNAMENTED_DUEL_SUPPLIES;
			}
			else if (finishDiff < 1860000)
			{
				tag = SeedOfInfinityController.NON_ORNAMENTED_DUEL_SUPPLIES;
			}
			else if (finishDiff < 1980000)
			{
				tag = SeedOfInfinityController.WEAK_LOOKING_DUEL_SUPPLIES;
			}
			else if (finishDiff < 2100000)
			{
				tag = SeedOfInfinityController.SAD_LOOKING_DUEL_SUPPLIES;
			}
			else if (finishDiff < 2220000)
			{
				tag = SeedOfInfinityController.POOR_LOOKING_DUEL_SUPPLIES;
			}
			else
			{
				tag = SeedOfInfinityController.WORTHLESS_DUEL_SUPPLIES;
			}
		}
	...
	{
		super(-1, HallOfSufferingDefence.class.getSimpleName(), "Hall Of Suffering Defence");
		StartNpcs(SeedOfInfinityController.TEPIOS, SeedOfInfinityController.EKIMUS_MOUTH);
		StartNpcs(SeedOfInfinityController.TEPIOS, SeedOfInfinityController.EKIMUS_MOUTH);
		KillNpcs(SeedOfInfinityController.TUMOR_OF_DEATH_ALIVE_79, SeedOfInfinityController.KLODEKUS, SeedOfInfinityController.KLANIKUS);
		AttackNpcs(SeedOfInfinityController.KLODEKUS, SeedOfInfinityController.KLANIKUS);
		SkillSeeNpcs(SeedOfInfinityController.TUMOR_MOBIDS);
		KillNpcs(SeedOfInfinityController.TUMOR_MOBIDS);
	}
	...
	private boolean checkConditions(L2PcInstance player)
	{
		...
		{
			if ((partyMember.getLevel() < Config.HALL_OF_SUFFERING_DEFENCE_MIN_LV_75) || (partyMember.getLevel() > Config.HALL_OF_SUFFERING_DEFENCE_MAX_LV_82))
			{
			...
			Long reentertime = InstanceManager.getInstance().getInstanceTime(partyMember.getObjectId(), SeedOfInfinityController.INSTANCE_ID_HALL_OF_SUFFERING_DEFENCE);
	...
	protected int enterInstance(L2PcInstance player, String template, teleCoord teleto)
	{
		...
		world = new DHSWorld();
		world.setTemplateId(SeedOfInfinityController.INSTANCE_ID_HALL_OF_SUFFERING_DEFENCE);
	...
	protected int[][] getRoomSpawns(int room)
	{
		...
		{
			case 0:
				return SeedOfInfinityController.ROOM_1_MOBS_HOSD;
			case 1:
				return SeedOfInfinityController.ROOM_2_MOBS_HOSD;
			case 2:
				return SeedOfInfinityController.ROOM_3_MOBS_HOSD;
			case 3:
				return SeedOfInfinityController.ROOM_4_MOBS_HOSD;
			case 4:
				return SeedOfInfinityController.ROOM_5_MOBS_HOSD;
		}
		return new int[][] {};
	}
	...
	protected void runTumors(DHSWorld world)
	{
		...
		L2Npc mob = addSpawn(SeedOfInfinityController.TUMOR_OF_DEATH_ALIVE_79, SeedOfInfinityController.TUMOR_SPAWNS_HOSD[world.getStatus()][0], SeedOfInfinityController.TUMOR_SPAWNS_HOSD[world.getStatus()][1], SeedOfInfinityController.TUMOR_SPAWNS_HOSD[world.getStatus()][2], 0, false, 0, false, world.getInstanceId());
	...
	{
		world.incStatus();
		world.klodekus = addSpawn(SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][0], SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][1], SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][2], SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][3], 0, false, 0, false, world.getInstanceId());
		world.klanikus = addSpawn(SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][0], SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][1], SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][2], SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][3], 0, false, 0, false, world.getInstanceId());
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (tmpworld instanceof DHSWorld)
		{
			...
			{
				L2Npc mob = addSpawn(SeedOfInfinityController.TWIN_MOBIDS[Rnd.get(SeedOfInfinityController.TWIN_MOBIDS.length)], SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][1], SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][2], SeedOfInfinityController.TWIN_SPAWNS_HOSD[0][3], 0, false, 0, false, npc.getInstanceId());
				((L2Attackable) mob).addDamageHate(((L2Attackable) npc).getMostHated(), 0, 1);
				if (Rnd.get(100) < 33)
				{
					mob = addSpawn(SeedOfInfinityController.TWIN_MOBIDS[Rnd.get(SeedOfInfinityController.TWIN_MOBIDS.length)], SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][1], SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][2], SeedOfInfinityController.TWIN_SPAWNS_HOSD[1][3], 0, false, 0, false, npc.getInstanceId());
					((L2Attackable) mob).addDamageHate(((L2Attackable) npc).getMostHated(), 0, 1);
				}
				startQuestTimer("spawnBossGuards", SeedOfInfinityController.BOSS_MINION_SPAWN_TIME, npc, null);
			}
	...
	public String onAttack(L2Npc npc, L2PcInstance attacker, int damage, boolean isSummon, L2Skill skill)
	{
		...
		if (tmpworld instanceof DHSWorld)
		{
			...
			else if (damage >= npc.getCurrentHp())
			{
				...
				{
					bossSimpleDie(npc);
					startQuestTimer("ressurectTwin", SeedOfInfinityController.BOSS_RESSURECT_TIME, npc, null);
				}
			}
		}
		return null;
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (tmpworld instanceof DHSWorld)
		{
			...
			else if ((world.getStatus() == 6) && ((npc.getNpcId() == SeedOfInfinityController.KLODEKUS) || (npc.getNpcId() == SeedOfInfinityController.KLANIKUS)))
			{
				if (world.klanikus.isDead() && world.klodekus.isDead())
				{
					...
					addSpawn(SeedOfInfinityController.TEPIOS, SeedOfInfinityController.TEPIOS_SPAWN_HOSD[0], SeedOfInfinityController.TEPIOS_SPAWN_HOSD[1], SeedOfInfinityController.TEPIOS_SPAWN_HOSD[2], 0, false, 0, false, world.getInstanceId());
					doCountCoffinNotifications = false;
				}
			}
			
			if (npc.getNpcId() == SeedOfInfinityController.TUMOR_OF_DEATH_ALIVE_79)
			{
				world.TumorIndex(-50);
				world.TumorCount(1);
				...
				{
					npc.deleteMe();
					L2Npc deadTumor = spawnNpc(SeedOfInfinityController.TUMOR_OF_DEATH_ALIVE_80, loc, 0, world.getInstanceId());
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npcId == SeedOfInfinityController.EKIMUS_MOUTH)
		{
			teleCoord tele = new teleCoord();
			tele.x = -174701;
			tele.y = 218109;
			tele.z = -9592;
			enterInstance(player, SeedOfInfinityController.HALL_OF_SUFFERING_DEFENCE_XML, tele);
			return null;
		}
		return "";
	}
	...
	public void notifyCoffinActivity(L2Npc npc, DHSWorld world)
	{
		...
		if (world.tumorIndex <= 0)
		{
			...
			L2Npc aliveTumor = spawnNpc(SeedOfInfinityController.TUMOR_OF_DEATH_ALIVE_79, loc, 0, world.getInstanceId());
